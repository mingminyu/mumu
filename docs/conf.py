...
latex_documents = [
    (master_doc, 'MUMU.tex', 'MUMU Documentation',
...
man_pages = [
    (master_doc, 'mumu', 'MUMU Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MUMU', 'MUMU Documentation',
     author, 'MUMU', 'One line description of project.',
     'Miscellaneous'),
]
